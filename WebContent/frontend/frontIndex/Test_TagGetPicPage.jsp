...
<body>
	...
	<jsp:useBean id="painterTagSvc" scope="page" class="com.painterTag.model.PainterTagService" />
	<jsp:useBean id="painterTagMapSvc" scope="page" class="com.painterTagMap.model.PainterTagMapService" />
	...
	<form method="post" action="TagGetPic" name="searchForm">
		...
		<c:forEach var="ptrno" items="${ptrnoList}">
			<div>
				<img
					src="<%=request.getContextPath()%>/painter/ShowImage?ptr_no=${ptrno}">
			</div>
		</c:forEach>
